import { bn254 } from './noble_bn254.ts'; 
import { ProjPointType } from './abstract/weierstrass.ts';
...
export const fp = BigInt("21888242871839275222246405745257275088548364400416034343698204186575808495617"); 
