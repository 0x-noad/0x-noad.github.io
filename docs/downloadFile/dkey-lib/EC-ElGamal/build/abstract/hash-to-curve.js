...
function expand_message_xmd(msg, DST, lenInBytes, H) {
    ...
    if (DST.length > 255)
        DST = H((0, utils_1.concatBytes)(stringToBytes('H2C-OVERSIZE-DST-'), DST));
...
function hash_to_field(msg, count, options) {
    ...
    for (let i = 0; i < count; i++) {
        ...
        for (let j = 0; j < options.m; j++) {
            ...
            e[j] = (0, modular_1.mod)(os2ip(tv), options.p);
        }
        u[i] = e;
    }
    return u;
...
function hashToCurve(Point, mapToCurve, def) {
    ...
    return {
        ...
        hashToCurve(msg, options) {
            ...
            msg = (0, utils_1.ensureBytes)(msg);
            const u = hash_to_field(msg, 2, Object.assign(Object.assign(Object.assign({}, def), { DST: def.DST }), options));
        ...
        encodeToCurve(msg, options) {
            if (!mapToCurve)
                throw new Error('CURVE.mapToCurve() has not been defined');
            msg = (0, utils_1.ensureBytes)(msg);
            const u = hash_to_field(msg, 1, Object.assign(Object.assign(Object.assign({}, def), { DST: def.encodeDST }), options));
