// ES Module version of curve.js
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
// Abelian group utilities
import * as modular_1 from './modular.mjs';
...
export function wNAF(c, bits) {
    ...
    const opts = (W) => {
        ...
        const windowSize = Math.pow(2, (W - 1)); // -1 because we skip zero
    ...
    return {
        ...
        wNAF(W, precomputes, n) {
            ...
            let p = c.ZERO;
            let f = c.BASE;
            const mask = BigInt(Math.pow(2, W) - 1); // Create mask with W ones: 0b1111 for W=4 etc.
...
export function validateBasic(curve) {
    modular_1.validateField(curve.Fp);
    ...
    // Set defaults
    return Object.freeze(Object.assign(Object.assign({}, modular_1.nLength(curve.n, curve.nBitLength)), curve));
}
